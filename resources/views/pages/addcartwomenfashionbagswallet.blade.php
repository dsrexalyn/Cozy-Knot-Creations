...
<div class="py-5 bg-violet-400 ">
<div class="w-full max-w-sm py-1 mb-10 ml-10 border rounded-lg shadow border-violet-400 bg-violet-300 mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://media.karousell.com/media/photos/products/2023/7/29/crochet_wallet_1690614011_b9d3ccde_progressive.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘞𝘰𝘮𝘦𝘯'𝘴 𝘍𝘢𝘴𝘩𝘪𝘰𝘯𝘴, 𝘉𝘢𝘨𝘴, & 𝘞𝘢𝘭𝘭𝘦𝘵</h5>
        </a>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-white bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-violet-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-violet-600 dark:hover:bg-violet-700 dark:focus:ring-violet-800">BUY NOW</a>
        </div>
    </div>
</div>
