...
<div class="py-5 bg-blue-400 ">
    <h2 class="mb-5 font-serif text-4xl font-extrabold text-center text-font-semibold font-weight-lighter text-font-italic text-justify-center ml-9 dark:text-white"> 𝐁𝐚𝐠 𝐂𝐫𝐨𝐜𝐡𝐞𝐭</h2>
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-blue-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/58/56/fd/5856fd5d62784cc910a988fe57412308.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘚𝘮𝘪𝘭𝘦𝘺 𝘍𝘢𝘤𝘦 𝘎𝘳𝘢𝘯𝘯𝘺 𝘉𝘢𝘨</h5>
        </a>
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-blue-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/736x/91/f8/b6/91f8b6c19ccb9fd0533c18e28213a2db.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘊𝘩𝘦𝘤𝘬𝘦𝘳𝘦𝘥 𝘎𝘳𝘢𝘯𝘯𝘺 𝘉𝘢𝘨</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-blue-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/57/f6/f8/57f6f89f48996656ae828e694b1aecc0.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘌𝘷𝘪𝘭 𝘌𝘺𝘦 𝘎𝘳𝘢𝘯𝘯𝘺 𝘉𝘢𝘨</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
