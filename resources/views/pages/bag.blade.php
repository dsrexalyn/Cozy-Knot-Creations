...
<div class="bg-blue-100 ">
    <h2 class="py-5 text-4xl font-semibold text-center font-weight-lighter text-font-italic text-justify-center ml-9 dark:text-white">𝐂𝐫𝐨𝐜𝐡𝐞𝐭 𝐁𝐚𝐠</h2>
    ...
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">𝘛𝘰𝘵𝘦 𝘉𝘢𝘨</h5>
        </a>
        ...
        <div class="flex items-center justify-between">
            <span class="text-3xl font-bold text-gray-900 dark:text-white">₱1,500</span>
            <a href="addcarttotebag" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
    </div>
    </figure>
    </div>
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="h-auto max-w-full rounded-lg" src="https://easycrochet.com/wp-content/uploads/2023/11/large-granny-sqaure-bag-pattern.jpg" alt="">
    </figure>
    </figure>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">𝘎𝘳𝘢𝘯𝘯𝘺 𝘉𝘢𝘨</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <div class="flex items-center justify-between">
            <span class="text-3xl font-bold text-gray-900 dark:text-white">₱1,500</span>
            <a href="addcartgrannybag" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
    </div>
    </div>
    </div>
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="h-auto max-w-full rounded-lg" src="https://i.pinimg.com/564x/aa/60/ad/aa60ad2851037e97fc32dd07e4c2a7f7.jpg" alt="">
    </figure>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">𝘔𝘪𝘯𝘪 𝘉𝘢𝘨</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="addcartminibag" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
    </div>
    </figure>
    </div>
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="h-auto max-w-full rounded-lg" src="https://i.pinimg.com/564x/1e/2f/64/1e2f64c7e22379fe7cd9a9037a15ec61.jpg" alt="">
    </figure>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">𝘊𝘶𝘵𝘦 𝘉𝘰𝘥𝘺 𝘉𝘢𝘨</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="addcartbodybag" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
    </div>
    </figure>
    </div>
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="h-auto max-w-full rounded-lg" src="https://i.pinimg.com/564x/67/fc/50/67fc50eb8666274d49a1004d812ea5b0.jpg" alt="">
    </figure>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">Cellphone 𝘉𝘢𝘨𝘴</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <div class="flex items-center justify-between">
            <span class="text-3xl font-bold text-gray-900 dark:text-white">₱450</span>
            <a href="addcartcellphonebags" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
    </div>
    </figure>
    </div>
...
<div class="text-center">
    <button class="font-serif text-lg text-black bg-blue-300 mt-4 mb-4 hover:bg-blue-500 focus:ring-4 focus:ring-blue-600 font-medium rounded-lg px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-contact" data-drawer-show="drawer-contact" aria-controls="drawer-contact">
