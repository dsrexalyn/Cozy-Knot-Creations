...
<div class="bg-purple-400 ">
    <h2 class="py-5 text-4xl font-semibold text-center font-weight-lighter text-font-italic text-justify-center ml-9 dark:text-white">𝐂𝐫𝐨𝐜𝐡𝐞𝐭 𝐖𝐚𝐥𝐥𝐞𝐭</h2>
    <div class="grid grid-cols-2 gap-10 mt-6 px-52 mb-13 md:grid-cols-3">


    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="h-auto max-w-full rounded-lg" src="https://crochetdreamz.com/wp-content/uploads/2022/05/Crochet-Card-Holder-2.jpg.webp" alt="">
    </figure>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">𝘞𝘢𝘭𝘭𝘦𝘵 𝘢𝘯𝘥 𝘊𝘦𝘭𝘭𝘱𝘩𝘰𝘯𝘦 𝘗𝘰𝘶𝘤𝘩
            </h5>
        </a>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="addcartwalletcellphonepouch" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Add to cart</a>
        </div>
    </div>
    </figure>
    </div>
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="h-auto max-w-full rounded-lg" src="https://media.karousell.com/media/photos/products/2023/7/29/crochet_wallet_1690614011_b9d3ccde_progressive.jpg" alt="">
    </figure>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">𝘞𝘰𝘮𝘦𝘯'𝘴 𝘍𝘢𝘴𝘩𝘪𝘰𝘯𝘴, 𝘉𝘢𝘨𝘴, & 𝘞𝘢𝘭𝘭𝘦𝘵</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <div class="flex items-center justify-between">
            <span class="text-3xl font-bold text-gray-900 dark:text-white">₱200</span>
            <a href="addcartwomenfashionbagswallet" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Add to cart</a>
        </div>
    </div>
    </figure>
    </div>
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div>
        <img class="h-auto max-w-full rounded-lg" src="https://i.pinimg.com/564x/55/3e/1f/553e1fd09ca2ad95001eb22830ee389f.jpg" alt="">
    </figure>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="mt-3 text-xl tracking-tight text-gray-900 dark:text-white">Checkered Card Holder Wallet</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <div class="flex items-center justify-between">
            <span class="text-3xl font-bold text-gray-900 dark:text-white">₱200</span>
            <a href="addcartcheckeredcardholderwallet" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">Add to cart</a>
        </div>
    </div>
    </figure>
    </div>
...
<div class="text-center">
    <button class="font-serif text-lg text-black bg-purple-500 mt-4 mb-4 hover:bg-purple-500 focus:ring-4 focus:ring-purple-700 font-medium rounded-lg px-5 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800" type="button" data-drawer-target="drawer-contact" data-drawer-show="drawer-contact" aria-controls="drawer-contact">
        Contact us if you want customize product
    </button>
 </div>

 <!-- drawer component -->
 <div id="drawer-contact" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-purple-300 w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-contact-label">
