...
<div class="py-5 bg-pink-400 ">
    <h2 class="mb-5 font-serif text-4xl font-extrabold text-center text-font-semibold font-weight-lighter text-font-italic text-justify-center ml-9 dark:text-white">𝐒𝐮𝐧𝐟𝐥𝐨𝐰𝐞𝐫 𝐊𝐞𝐲𝐜𝐡𝐚𝐢𝐧</h2>
    ...
    <div class="w-full max-w-sm py-1 mb-10 ml-3 bg-pink-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/e0/ac/a9/e0aca9f40c0dc9e7018dc6819c074ca2.jpg" alt="product image" />
        </a>
        <div class="px-5 py-5">
            <a href="#">
                <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘚𝘶𝘯𝘧𝘭𝘰𝘸𝘦𝘳 𝘊𝘩𝘢𝘳𝘮𝘴🌻</h5>
            </a>
    ...
    <div class="w-full max-w-sm py-1 mb-10 ml-3 bg-pink-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/a1/a1/de/a1a1de034be22cb5b000276ff50ab086.jpg" alt="product image" />
        </a>
        <div class="px-5 py-5">
            <a href="#">
                <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘚𝘶𝘯𝘧𝘭𝘰𝘸𝘦𝘳 𝘊𝘩𝘢𝘳𝘮𝘴🌻</h5>
    ...
    <div class="w-full max-w-sm py-1 mb-10 ml-3 bg-pink-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/5e/6a/c3/5e6ac31c3adf5efb46573990f8b814fc.jpg" alt="product image" />
        </a>
        <div class="px-5 py-5">
            <a href="#">
                <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘚𝘶𝘯𝘧𝘭𝘰𝘸𝘦𝘳 𝘊𝘩𝘢𝘳𝘮𝘴🌻</h5>
