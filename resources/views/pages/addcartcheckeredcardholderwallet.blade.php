...
<div class="w-full max-w-sm py-1 mb-10 ml-10 border rounded-lg shadow border-violet-400 bg-violet-300 mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/55/3e/1f/553e1fd09ca2ad95001eb22830ee389f.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">Checkered Card Holder Wallet</h5>
        </a>
