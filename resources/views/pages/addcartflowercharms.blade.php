...
<div class="py-5 bg-pink-400 ">
    <h2 class="mb-5 font-serif text-4xl font-extrabold text-center text-font-semibold font-weight-lighter text-font-italic text-justify-center ml-9 dark:text-white">𝐅𝐥𝐨𝐰𝐞𝐫 𝐊𝐞𝐲𝐜𝐡𝐚𝐢𝐧</h2>
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-pink-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/37/9c/0e/379c0ef6a482e1352a8c191da4d50cf7.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘍𝘭𝘰𝘸𝘦𝘳 𝘊𝘩𝘢𝘳𝘮𝘴🌸</h5>
        </a>
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-pink-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/8a/83/da/8a83daf7d8d5b17b4452fca9b1a5c4db.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘍𝘭𝘰𝘸𝘦𝘳 𝘊𝘩𝘢𝘳𝘮𝘴🌸</h5>
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-pink-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/736x/c2/c0/a9/c2c0a985d519f078cdffb9a8d1e2f6bb.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘍𝘭𝘰𝘸𝘦𝘳 𝘊𝘩𝘢𝘳𝘮𝘴🌸</h5>
