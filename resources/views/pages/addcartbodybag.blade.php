...
<div class="py-5 bg-blue-400 ">
    <h2 class="mb-5 font-serif text-4xl font-extrabold text-center text-font-semibold font-weight-lighter text-font-italic text-justify-center ml-9 dark:text-white"> 𝐁𝐨𝐝𝐲 𝐁𝐚𝐠𝐬 𝐂𝐫𝐨𝐜𝐡𝐞𝐭</h2>
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-blue-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/a2/1b/58/a21b58c45c2637a3535e9dc89ce92391.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘞𝘩𝘪𝘵𝘦 𝘉𝘰𝘥𝘺 𝘉𝘢𝘨</h5>
        </a>
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-blue-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/22/2a/cd/222acd09abd4b71c4b7af95e16b47ec4.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘞𝘩𝘪𝘵𝘦 𝘉𝘰𝘥𝘺 𝘉𝘢𝘨 𝘸𝘪𝘵𝘩 𝘛𝘶𝘭𝘪𝘱𝘴 𝘒𝘦𝘺𝘤𝘩𝘢𝘪𝘯</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
...
<div class="w-full max-w-sm py-1 mb-10 ml-3 bg-blue-200 border border-gray-200 rounded-lg shadow mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://i.pinimg.com/564x/d3/12/5d/d3125dc9f3ca2624e7afceebee4adfae.jpg" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘋𝘢𝘪𝘴𝘺 𝘠𝘦𝘭𝘭𝘰𝘸 𝘉𝘰𝘥𝘺 𝘉𝘢𝘨</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
