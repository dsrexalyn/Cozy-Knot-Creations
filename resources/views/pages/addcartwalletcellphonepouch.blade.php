...
<div class="w-full max-w-sm py-1 mb-10 ml-10 border rounded-lg shadow border-violet-400 bg-violet-300 mr-52 dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="px-5 py-5 rounded-t-lg" src="https://crochetdreamz.com/wp-content/uploads/2022/05/Crochet-Card-Holder-2.jpg.webp" alt="product image" />
    </a>
    <div class="px-5 py-5">
        <a href="#">
            <h5 class="text-3xl tracking-tight text-gray-900 dark:text-white">𝘞𝘢𝘭𝘭𝘦𝘵 𝘢𝘯𝘥 𝘊𝘦𝘭𝘭𝘱𝘩𝘰𝘯𝘦 𝘗𝘰𝘶𝘤𝘩
            </h5>
        </a>
